...
class HotelSellerForm extends StatefulWidget {
  const HotelSellerForm({super.key});

  static const String id = 'hotel-form';

  @override
  State<HotelSellerForm> createState() => _HotelSellerFormState();
}

class _HotelSellerFormState extends State<HotelSellerForm> {
                ...
                child: Column(
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      hint: const Text('Cleaning Service '),
                      value: cleaningservice,
                      onChanged: (String? newValue) {
                        setState(() {
                          cleaningservice = newValue!;
                        });
                      },
                      items: <String>['available', 'Not Available']
                          .map<DropdownMenuItem<String>>((String value) {
